      ...
      <div style="height: 60px;position: absolute;width:100%;padding: 0 10px;top: 0;z-index: 2;background: #FAFAFA">
        ...
        <div style="color: #454545;width:100%;display: flex;align-items: center;justify-content: space-between;background: #FAFAFA">
          ...
          <div style="font-size: 12px;display: inline">
            <svg-icon class="discolour" name="batch" style="margin-right: 10px" />
            <svg-icon class="discolour" name="trash" />
          </div>
        </div>
      </div>
        ...
        >
          <div class="info" :style="index===selectIndex?'width: 60%':''">
            <div style="display: flex;flex-direction: row;align-items: center">
              ...
              <svg-icon
                name="SQ"
                style="font-size: 28px;height:16px;color: var(--primary-color);min-width: 28px;margin-left: 5px"
              />
              <lottie-player
          ...
          <div class="icons" :style="index===selectIndex?'width: 40%;display: flex;justify-content: flex-end;':''">
            <svg-icon class="icon discolour" :name="index===currIndex?'listPause':'listPlay'" />
            <svg-icon class="icon discolour" name="love-line" />
            <svg-icon class="icon discolour" name="more" />
          </div>
        </div>
      </div>
    </Drawer>
